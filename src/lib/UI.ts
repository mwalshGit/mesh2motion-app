export class UI {
  ...
  dom_human_quick_fit_container: HTMLElement | null = null
  dom_accept_human_fit_button: HTMLButtonElement | null = null
  ...
  private initialize_dom_elements (): void {
    ...
    this.dom_human_quick_fit_container = document.querySelector('#human-quick-fit-container')
    this.dom_accept_human_fit_button = document.querySelector('#accept-human-fit-button')
